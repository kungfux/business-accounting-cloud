            ...
            const [result] = await this.db.query(
                ...
                'values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)',
                {
                    replacements: [
                        ...
                        request.body.dob ? new Date(request.body.dob).toISOString() : null,
                        request.body.note || null,
                        request.body.hired ? new Date(request.body.hired).toISOString() : null,
                        request.body.fired ? new Date(request.body.fired).toISOString() : null,
